...
const Data = (() => {
  ...
  const purchaseOrders = [
    { id: 'OC-2026-00481', supplier: 'Hardware y Componentes del Pacífico', monto: 248640.00, fecha: '23 may 2026', entrega: '04 jun 2026', estado: 'Aprobada', tone: 'success', items: 6, owner: 'María E. Rodríguez' },
    ...
    { id: 'OC-2026-00459', supplier: 'Hardware y Componentes del Pacífico', monto: 78420.00, fecha: '12 may 2026', entrega: '22 may 2026', estado: 'Cerrada', tone: 'neutral', items: 5, owner: 'María E. Rodríguez' },
  ...
  const rfqs = [
    ...
    { id: 'RFQ-026-114', titulo: 'Suministro de servidores rack 2U', invitados: 6, respuestas: 5, cierre: '28 may 2026', estado: 'En evaluación', tone: 'accent', owner: 'María E. Rodríguez' },
  ...
  const activity = [
    { tipo: 'invoice', who: 'María E. Rodríguez', what: 'aprobó la factura', target: 'FAC-A-1183', when: 'hace 12 min', tone: 'success' },
